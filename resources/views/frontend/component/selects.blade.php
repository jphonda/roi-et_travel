                ...
                <nav class="top-nav">
                  <ul class="nav sf-menu">
                    ...
                    <li>
                      ...
                      <ul>                      
                        <li><a href="{{url('/status/0')}}">เส้นทางสายบุญ/ไหว้พระ</a></li>
                        <li><a href="{{url('/select/1')}}" >เส้นทางสายธรรมชาติ</a></li>
                        <li><a href="{{url('/select/2')}}" >เส้นทางแหล่งเรียนรู้
                            /การศึกษา/ประวัติศาสตร์</a></li>
                        <li><a href="{{url('/select/3')}}" >เส้นทางสายแช๊ะ ชิม ช๊อป ชิลล์</a></li>
                      </ul>
                    </li>
                    <li>
