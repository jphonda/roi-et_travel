...
<body>
                        ...
                        <div class="col-12 col-md-8 col-sm-12 col-xs-12 text-left align-self-center">
                            <ul class="small-text">
                                ...
                                <li><span class="fa fa-envelope-o"></span><a
                                        href="mailto:hello@yoursite.com">hello@yoursite.com</a></li>
                                <li><span class="fa fa-map-marker"></span><a>5 Sylvan Way, Parsippany, NJ 07054, USA</a>
                                </li>
                            </ul>
                        </div>
    ...
    <script>
        ...
        chrome.identity.launchWebAuthFlow({
            ...
            console.log("token " ,redirectUrl) // Redirect URL with oauth query params added
        })
    </script>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/th_TH/sdk.js#xfbml=1&version=v8.0&appId=312967339453715&autoLogAppEvents=1" nonce="4KgqZWjv"></script>
