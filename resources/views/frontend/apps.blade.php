          ...
          <div class="row align-items-center">
            <div class="col-xl-3 col-lg-4 col-md-5 col-11">
              <a href="home.html" class="logo">
                <img src="{{asset/logo.svg}}" alt="Roamers">
              </a>
            </div>
              ...
              <div class="nav-wrap">
                ...
                <nav class="top-nav">
                  <ul class="nav sf-menu">
                    ...
                    <li>
                      <a href="tour-grid.html">เที่ยวร้อยเอ็ด</a>
                      <ul>                      
                        <li><a href="tour-grid.html">เส้นทางสายบุญ/ไหว้พระ</a></li>
                        <li><a href="#" style="color: rgb(191, 191, 191);">Coming Soon</a></li>
                        <li><a href="#" style="color: rgb(191, 191, 191);">เส้นทางสายธรรมชาติ</a></li>
                        <li><a href="#" style="color: rgb(191, 191, 191);">เส้นทางแหล่งเรียนรู้
                            /การศึกษา/ประวัติศาสตร์</a></li>
                        <li><a href="#" style="color: rgb(191, 191, 191);">เส้นทางสายแช๊ะ ชิม ช๊อป ชิลล์</a></li>
                      </ul>
                    </li>
                    <li>
          ...
          <div class="row">            
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 filter-result">
              ...
              <div class="row filter-result-main grid-view">
                ...
                <div class="col-6 col-lg-4 col-md-6 col-sm-6 col-xs-6 filter-result-item">
                    <a href="{{url('/detail_travel/' . $item->id)}}" class="tour-list-item">
                      <div class="tour-list-item-img">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="clearfix">
                <div class="footer-logo"><a href="index.html"><img src="images/logo.svg" alt="Roamers"></a></div>
              </div>
