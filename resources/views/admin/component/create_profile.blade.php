            ...
            <div class="d-flex justify-content-center col-8  m-0 p-0">
                <div class="mb-4 border-0 w-100" style="box-shadow: 1px 1px 5px 1px rgb(235, 235, 235)">
                    ...
                    <div class="card-body  d-flex justify-content-center m-0 p-0">
                        {{-- @foreach ($__genId as $item)
                        @endforeach --}}
                        <form id="form" method="POST" action="{{ url('/create_travel/') }}" enctype="multipart/form-data"
                            class="text-center">
                            {{ csrf_field() }}
                            {{ method_field('POST') }}
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <input type="text" name="name" class="w-100" value=""
                                    ...
                                    <div class="col-4 d-flex align-items-center justify-content-center">
                                        ...
                                        <select id="status" name="status"
                                            ...
                                            <option value="3" selected>แช๊ะ,ชิม,ช๊อป,ชิลล์</option>
                                        </select>
                                    </div>
                                </div>
                                <br>
                            ...
                            <div class="form-group text-left " style="background: rgb(247, 250, 255)">
                                <div class="container">
                                    ...
                                    <div class="quill-wrapper">
                                        ...
                                        <input type="text" name="map" class="w-100" value=""
                           ...
                           <div class="d-row">
                            ...
                            <div class="quote-imgs-thumbs quote-imgs-thumbs--hidden" id="img_preview" style=""  aria-live="polite">
                                <div class="img-preview-thumb col-lg-2"></div>    
                            </div>                                    
                           </div>

                            <button type="submit" id="submit-all" class="btn btn-primary margin:40px"
                                style="position: absolute; bottom:10px; right:10px">บันทึก</button>
