<!-- Page Wrapper -->
<div id="wrapper" style="display: f">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{url('/__genId')}}">เพิ่มสถานที่ท่องเที่ยว</a>
          <a class="collapse-item" href="{{url('/table_place')}}">แก้ไข / ลบ </a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
        ...
        <span>สินค้าโอท็อป</span>
      </a>
      <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">จัดการข้อมูล :</h6>
          <a class="collapse-item" href="{{url('/otop')}}">เพิ่มสินค้า</a>
          <a class="collapse-item" href="{{url('/table_otop')}}">แก้ไข / ลบ</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">จัดการข้อมูล:</h6>
          <a class="collapse-item" href="/manage-user">เพิ่มสมาชิก</a>
          <a class="collapse-item" href="register.html">แก้ไขสิทธิ</a>
          <a class="collapse-item" href="forgot-password.html">แก้ไข / ลบข้อมูล</a>
        </div>
      </div>
    </li>
